...
st.write('This app is designed for helping you choose the particular episode of Friends that you are in the mood for. You have two ways to choose! One is via a supervised method and the other is the unsupervised method. Whatever method you choose will spit out 5 recommended episodes when you hit submit.')




option=st.sidebar.selectbox('Which method would you like?',(' ', 'Supervised','Unsupervised'))

if st.sidebar.button('Explain Method'):
...
if st.sidebar.button("Start Recommending"):
	if option=='Supervised':
		domethod1()
